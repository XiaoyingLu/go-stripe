...
// BronzePlanReceipt displays the recipt for bronze plans
...
func (app *application) ShowResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	theUrl := r.RequestURI
	app.infoLog.Println(theUrl) // /reset-password?email=admin@example.com&hash=.3DRGgA.BhvALNqBH1ix4N__Wr711Wjlkv_9L4selLCT3i9PCKk
	...
	expired := signer.Expired(testURL, 60) // 60 minutes
	if expired {
